...
class ModelArguments:
    ...
    projector_path: str = field(default=None, metadata={"help": "path to the projector model, if set, will use the projector model to encode the embedding features"})
    ref_model_name: str = field(default=None, metadata={"help": "path to the ref model model, if set, will use the projector model to encode the embedding features"})

@dataclass
class DataArguments:
    dataset_config: str = field(default=None, metadata={"help": "yaml file with dataset configuration", "nargs": '+'})
    ...
    task_type: str = field(default='retrieval', metadata={"help": "task type"})
...
class TrainingArguments(TrainingArguments):
    ...
    num_train_epochs: float = field(default=1.0, metadata={"help": "number of training epochs"})
    ...
    multi_turn: bool = field(default=False, metadata={"help": "whether to use multi-turn"})
    loss_weight: Optional[str] = field(default=None, metadata={"help": "loss weight type"})