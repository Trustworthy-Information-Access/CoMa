...
from src.model.processor import process_input_text, postprocess_input_text
...
def data_prepare(batch_dict, *args, **kwargs):
    ...
    query_texts, cand_texts = postprocess_input_text(query_texts, cand_texts, model_backbone)
