...
def shift_sep_indices(sep_indices, inputs_len, padding_side="left"):
    if padding_side == "right":
        return sep_indices
    max_inputs_len = max(inputs_len)
    shift_offset = [max_inputs_len - x for x in inputs_len]
    for i, offset in enumerate(shift_offset):
        sep_indices[i] += offset
    return sep_indices
